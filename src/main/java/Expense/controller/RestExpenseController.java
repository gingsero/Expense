...
public class RestExpenseController {
	...
	@GetMapping("/getList")
	public ResponseEntity<Object> getExpense(@RequestParam("date") String use_date, @RequestParam("name") String name, @RequestParam("process_status") String process_status){
		...
		// 일다 주석처리 List<Expense> expense = service.getProcessList(use_date, name, process_status);
		//if(expense == null) {
